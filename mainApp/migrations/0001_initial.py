# Generated by Django 2.1.7 on 2019-02-27 20:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_desc', models.CharField(blank=True, max_length=255, verbose_name='харрактеристика кратко')),
                ('description', models.TextField(blank=True, verbose_name='харректеристика подробно')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=256, unique=True, verbose_name='харрактеристика категории')),
            ],
            options={
